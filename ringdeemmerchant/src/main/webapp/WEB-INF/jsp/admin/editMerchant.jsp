        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form:form method="post" modelAttribute="merchantForm" id="merchantForm" action="${contextPath}/saveMerchant" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Edit Merchant details</h4>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <spring:bind path="contactName">
                                               <form:input type="text" path="contactName" class="form-control" id="contactName" placeholder="Last Name Here"></form:input>
                                            </spring:bind>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <spring:bind path="image">
                                               <form:input type="file" path="image"  onchange="Filevalidation()" accept="image/*"  class="form-control" id="image" placeholder="Mobile Number here"></form:input>
                                            </spring:bind>
