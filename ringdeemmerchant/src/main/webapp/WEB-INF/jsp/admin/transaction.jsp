...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col col-md-12">
                                        <label for="seloption">Country: </label>
                                        <div class="form-group">

                                       <select id="seloption" class="form-control" onchange="changeCountryURL()" class="">
                                        <option value="All">--select ALL--</option>
                                        <c:if test="${not empty countryList}">
                                            <c:forEach var="country" items="${countryList}">
                                                <option value="<%=request.getContextPath()%>/viewTransactionBycountry/${country.key}">${country.value}</option>
                                            </c:forEach>
                                        </c:if>
                                        </select>
                                        </div>
                                    ...
                                    <div class="col col-md-12">
                                        <a href="<%=request.getContextPath()%>/viewTransactionBycountry/All" class="btn btn-info">Search by country</a>
                                    </div>
                                </div>
  ...
  <!-- data table -->
      ...
      <script>
                      ...
                      function changeCountryURL()
                      {
                        var url=document.getElementById("seloption").value;
                        $("a").attr("href", url);
                      }
