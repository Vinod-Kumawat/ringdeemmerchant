 ...
 <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a href="<%=request.getContextPath()%>/index" class="sidebar-link waves-effect waves-dark sidebar-link" href="#index.html" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-store"></i><span class="hide-menu">Product </span></a>
                             <ul aria-expanded="false" class="collapse  first-level">
                                   ...
                                   <li class="sidebar-item"><a href="<%=request.getContextPath()%>/viewProduct" class="sidebar-link"><i class="mdi mdi-store"></i><span class="hide-menu"> View All Product </span></a></li>
                                   <!--
                                   <li class="sidebar-item"><a href="<%=request.getContextPath()%>/viewProduct" class="sidebar-link"><i class="mdi mdi-store"></i><span class="hide-menu"> View Merchant's Product</span></a></li>
                                   <li class="sidebar-item"><a href="<%=request.getContextPath()%>/viewTransaction" class="sidebar-link"><i class="mdi mdi-store"></i><span class="hide-menu"> View Merchant's Transaction</span></a></li>
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<%=request.getContextPath()%>/transaction" aria-expanded="false"><i class="mdi mdi-bank"></i><span class="hide-menu"> All Transaction </span></a></li>
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<%=request.getContextPath()%>/viewAllWalletTopup" aria-expanded="false"><i class="mdi mdi-wallet"></i><span class="hide-menu"> Pending Wallet Topup </span></a></li>
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<%=request.getContextPath()%>/viewApprovedWalletTopup" aria-expanded="false"><i class="mdi mdi-wallet-travel"></i><span class="hide-menu">Approved Wallet Topup </span></a></li>
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<%=request.getContextPath()%>/viewInboxQuery" aria-expanded="false"><i class="fas fa-comment-dots"></i><span class="hide-menu"> Inbox Query</span></a></li>
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<%=request.getContextPath()%>/viewResolvedQuery" aria-expanded="false"><i class=" fas fa-comment-slash"></i><span class="hide-menu"> Resolved Query</span></a></li>
<!--
