                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <c:if test="${not empty productList}">
                                            ...
                                            <tr>
                                                <td><a href="${contextPath}/merchant/editProduct/${product.productId}" class="btn btn-success btn-cm">${product.productId}</a></td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="${contextPath}/merchant/deleteProduct/${product.productId}" class="btn btn-danger btn-sm">Delete</a>
                                                </td>
                                            </tr>
                                            </c:forEach>
                                        </c:if>
