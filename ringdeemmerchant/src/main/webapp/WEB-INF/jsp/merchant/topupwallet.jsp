                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <c:if test="${not empty message}">
                            ...
                            <form:form method="post" modelAttribute="wallet"  action="${contextPath}/merchant/savewallet" class="form-horizontal"  enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <spring:bind path="merchantId">
                                                <form:input type="text" path="merchantId" value="<%=merchant.getMerchantId() %>" class="form-control" id="mechantID" placeholder="mechant ID" readonly="true"></form:input>
                                            </spring:bind>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            <label for="productName" class="col-sm-3 text-left control-label col-form-label">Amount</label>
                                            <div class="col-sm-9">
                                            <spring:bind path="amount">
                                                <form:input  type="amount" path="amount" class="form-control" id="amount" placeholder="amount "></form:input>
                                            </spring:bind>
                                            </div>
                                        </div>
                                    </div>
